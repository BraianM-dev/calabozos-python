...
var CACHE="calabozos-python-v1-8-4";
var CORE=[
  "./assets/journey.css","./assets/journey.js","./assets/responsive.css","./assets/campaigns.css","./assets/premium-v184.css","./assets/campaigns.js","./assets/campaign-runtime.js",
  ...
  "./assets/v16.css","./assets/accessibility.js","./assets/ficha-pdf.js","./assets/logo-pdf-data.js","./assets/heroes-pdf-data.js","./assets/campaign-heroes-pdf-data.js","./assets/qr-pdf-data.js","./assets/manual-campaign.js",
...
['calabozos','arcana','multiverso'].forEach(function(camp){CLASSES.forEach(function(c){CORE.push('./assets/campaigns/'+camp+'/portraits/'+c+'.png');if(camp!=='calabozos')CORE.push('./assets/campaigns/'+camp+'/sprites/'+c+'.png')})});
