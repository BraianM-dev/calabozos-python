...
var CACHE="calabozos-python-v1-8-2";
var CORE=[
  "./assets/journey.css","./assets/journey.js","./assets/responsive.css","./assets/campaigns.css","./assets/campaigns.js","./assets/campaign-runtime.js",
...
CLASSES.forEach(function(c){STAGES.forEach(function(s){CORE.push("./assets/hero-sprites/"+c+"-"+s+".svg")})});["inicial","veterano","legendario"].forEach(function(s){CORE.push("./assets/hero-evolution/hero-mago-"+s+".svg")});
